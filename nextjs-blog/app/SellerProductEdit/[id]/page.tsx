        ...
        <section className='p-14 shadow-md '>
            <form className="max-w-md mx-auto">
                ...
                <div style={{"display":"flex","justifyContent":"flex-end"}}>
                    ...
                    <button type="submit" className="focus:outline-none text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" onClick={()=>{updateProduct(),navigate('/Seller/1')}}>
                        Confirm Changes
                    </button>
                </div>
            </form>
