        ...
        <div className="container mx-auto py-8">
            ...
            <section className='p-8 bg-white bg-opacity-80 rounded-lg shadow-md'>
                <form className="max-w-md mx-auto">
                    <p className="text-lg text-gray-700 mb-4">Add A New Product</p>
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Product Name</label>
                        <input
                            className="w-full py-2.5 px-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex items-center">
                            <button
                                type="button"
                                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-l-lg focus:outline-none focus:border-blue-500"
                                onClick={() => setQuantity((prevQuantity) => Math.max(1, prevQuantity - 1))}
                            >
                                -
                            </button>
                            <input
                                className="w-16 text-center text-sm text-gray-900 bg-white border-t border-b border-gray-300 focus:outline-none focus:border-blue-500"
                                type="text"
                                value={quantity}
                                readOnly
                            />
                            <button
                                type="button"
                                className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-r-lg focus:outline-none focus:border-blue-500"
